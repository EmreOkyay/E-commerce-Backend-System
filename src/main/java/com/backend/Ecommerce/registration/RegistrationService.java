...
public class RegistrationService {
    ...
    @Autowired
    public RegistrationService(AppUserService appUserService, EmailValidator emailValidator, ConfirmationTokenService confirmationTokenService, EmailSender emailSender, UserProducer userProducer, EmailTemplateServiceImpl emailTemplateService) {
